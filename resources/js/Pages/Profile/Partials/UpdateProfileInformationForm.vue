...
<template>
    <section>
        <header>
            <h2 class="text-lg font-semibold text-cthulhu-green-900">Profile Information</h2>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="text-sm mt-2 text-cthulhu-green-800">
            ...
            <div class="flex items-center gap-4">
                ...
                >
                    <p v-if="form.recentlySuccessful" class="text-sm text-cthulhu-green-700">Saved.</p>
                </Transition>
            </div>
        </form>
    </section>
